...
export const MBTI_ITEMS_I18N: {
  ...
  en: [
    {
      type: "ISTJ",
      description: "realistic and thorough planning, stable dating",
      detail: "type that pursues and gives trust to the other person",
    },
    {
      type: "ISFJ",
      description:
        "quiet and considerate, understanding the other person's emotions well",
      detail: "but having difficulty expressing their own emotions type",
    },
    {
      type: "INFJ",
      description: "creative and intuitive, deep thinking",
      detail: "type with strong patience",
    },
    {
      type: "INTJ",
      description: "logical and analytical, strong intellectual",
      detail: "independent and future-oriented type",
    },
    {
      type: "ISTP",
      description: "curious and observant, free dating",
      detail: "type that enjoys new experiences and challenges",
    },
    {
      type: "ISFP",
      description: "emotional and artistic, warm and gentle",
      detail: "type that hides their emotions",
    },
    {
      type: "INFP",
      description: "imaginative and creative",
      detail: "romantic and kind style",
    },
    {
      type: "INTP",
      description: "original and innovative ideas, solving complex problems",
      detail: "type with strong ability but having difficulty in relationships",
    },
    {
      type: "ESTP",
      description: "active and proactive, enjoying adventures",
      detail: "fun and cheerful style",
    },
    {
      type: "ESFP",
      description: "bright and sociable, attractive and",
      detail: "leading the atmosphere well and cheerful style",
    },
    {
      type: "ENFP",
      description: "passionate and creative, valuing various experiences",
      detail: "type with a lot of affection but also impulsive",
    },
    {
      type: "ENTP",
      description: "original and creative, challenging spirit",
      detail: "open-minded dating and attractive style",
    },
    {
      type: "ESTJ",
      description: "realistic and practical thinking",
      detail:
        "type that pursues systematic dating and has a strong sense of responsibility",
    },
    {
      type: "ESFJ",
      description: "kind and considerate, stable dating",
      detail: "type that values relationships with others",
    },
    {
      type: "ENFJ",
      description: "empathetic and dedicated",
      detail: "warm-hearted and deeply caring type",
    },
    {
      type: "ENTJ",
      description: "strong leadership and goal-oriented",
      detail: "dating style that prefers proactive and strong self-assertion",
    },
  ],
};
